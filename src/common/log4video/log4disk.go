...
var (
	...
	//TODO: for now, just use stdout
	Writer io.Writer = os.Stdout
)

func init() {
	verbose = log.New(Writer, "[go-video] [VERBOSE] ", log.Ldate|log.Lmicroseconds|log.Llongfile)
	debug = log.New(Writer, "[go-video] [DEBUG] ", log.Ldate|log.Lmicroseconds|log.Llongfile)
	info = log.New(Writer, "[go-video] [INFO] ", log.Ldate|log.Lmicroseconds|log.Llongfile)
	warn = log.New(Writer, "[go-video] [WARN] ", log.Ldate|log.Lmicroseconds|log.Llongfile)
	error = log.New(Writer, "[go-video] [ERROR] ", log.Ldate|log.Lmicroseconds|log.Llongfile)
